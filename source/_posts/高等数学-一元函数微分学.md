...
**垂直渐近线**
若$\lim\limits_{x\rightarrow\infty}f(x)=\infty$(或$\lim\limits_{x\rightarrow-\infty}f(x)=\infty,or\lim\limits_{x\rightarrow+\infty}f(x)=\infty$)，那么$x=x_0$是曲线$y=f(x)$的垂直渐近线
